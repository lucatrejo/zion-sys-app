...
class UserProfile extends React.Component {
    constructor(props) {
        ...
        this.state = {
            tableHeader: ["Artículo", "Cantidad", "Precio de Compra", "Proveedor", "Fecha"],
            endpointUrl: `http://${REACT_APP_SERVER_URL}/purchases/purchases_month`,
            tableData: [],
            reportData: [],
        };
                                    ...
                                    <GridContainer>
                                        <GridItem xs={3} sm={3} md={3}>
                                            <Button type="button" color="info" size="xs"
                                                    onClick={() => generatePDFPurchases(this.state.reportData)}>
                                                Generar PDF
                                            </Button>
                                        </GridItem>
                                    </GridContainer>
