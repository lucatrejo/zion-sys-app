...
import generateListadoMorosos from "components/Reports/reportClientesMorosos";
...
class UserProfile extends React.Component {
    constructor(props) {
        ...
        this.state = {
            ...
            endpointUrl: `http://${REACT_APP_SERVER_URL}/customers/morosos`,
            tableData: [],
            reportData: [],
        };
                        ...
                        <form onSubmit={this.insertObject}>
                            <Card>
                                <CardHeader color="info">
                                    <h4 className={classes.cardTitleWhite}>Listado de Clientes Morosos</h4>
                                </CardHeader>
                                <CardBody>
                                    ...
                                    <GridContainer>
                                        <GridItem xs={3} sm={3} md={3}>
                                            <Button type="button" color="info" size="xs"
                                                    onClick={() => generateListadoMorosos(this.state.reportData)}>
                                                Generar PDF
                                            </Button>
                                        </GridItem>
                                    </GridContainer>
