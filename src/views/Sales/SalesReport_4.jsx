...
class UserProfile extends React.Component {
    constructor(props) {
        ...
        this.state = {
            tableHeader: ["Empleado", "Fecha", "Articulo", "Cantidad", "Precio"],
            endpointUrl: `http://${REACT_APP_SERVER_URL}/sales/sales_employee`,
            tableData: [],
            reportData: [],
        };
                        ...
                        <form onSubmit={this.insertObject}>
                            <Card>
                                <CardHeader color="info">
                                    <h4 className={classes.cardTitleWhite}>Reporte de Ventas por Empleado</h4>
                                </CardHeader>
                                <CardBody>
                                    ...
                                    <GridContainer>
                                        <GridItem xs={3} sm={3} md={3}>
                                            <Button type="button" color="info" size="xs"
                                                    onClick={() => generatePDFSalesEmployee(this.state.reportData)}>
                                                Generar PDF
                                            </Button>
                                        </GridItem>
                                    </GridContainer>
