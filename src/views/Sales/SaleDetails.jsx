...
class UserProfile extends React.Component {
    ...
    fillCombos(e) {
        axios.get(`http://${REACT_APP_SERVER_URL}/sales/` + this.state.id)
            .then(res => {
                this.setState({employeeComboVal: res.data.employee_id});
                this.setState({customerComboVal: res.data.customer_id});
                this.setState({date: res.data.date});
            })
    }

    fillTableDetails(e) {
        axios.get(`http://${REACT_APP_SERVER_URL}/sales/` + this.state.id + `/details`)
            .then(res => {
                        ...
                        <form onSubmit={this.insertObject}>
                            <Card>
                                <CardHeader color="info">
                                    ...
                                    <p className={classes.cardCategoryWhite}>Detalle de Venta</p>
                                </CardHeader>
                                <CardBody>
                                    <GridContainer>
